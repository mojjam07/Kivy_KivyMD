...
class CustomScreen(Screen):
	...
	def __init__(self, **kwargs):
		...
		# code is compatibile in both version
		super(CustomScreen, self).__init__(**kwargs)
		# Put a layout in the Screen which will take
		# Screen's size and pos.
		
		# The 'orientation' represents a direction
		# in which the widgets are added into the         		# BoxLayout - 'horizontal' is the default
		...
		# Bind to 'on_release' events of Buttons         prev.bind(on_release=self.switch_prev)
